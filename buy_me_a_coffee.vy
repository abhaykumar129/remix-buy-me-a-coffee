...
#   or   assert msg.value > 1 *(10 **18)
    # assert msg.value >=as_wei_value(1,"ether"),"You msut spend more ETH!"

    # assert msg.value >=self.minimum_usd,"You msut spend more ETH!"
